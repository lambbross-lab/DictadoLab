          ...
          {!isForgotPassword && !isResettingPassword && (
            <>
              <button
                ...
                disabled={loading}
                className="w-full py-3 mb-6 bg-white border border-slate-200 rounded-xl font-semibold text-slate-700 hover:bg-slate-50 transition-all shadow-sm flex items-center justify-center gap-3"
              >
