...
export default function AuthPage() {
  ...
  const handleClose = () => {
    // If we were redirected here from a protected route, closing should take us to home
          ...
          {resetSent ? (
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="bg-slate-50 p-4 rounded-xl text-slate-600 text-sm leading-relaxed text-left border border-slate-100">
                <p className="mb-2">Te hemos enviado un enlace de verificación. Revisa tu bandeja de entrada y haz clic en el enlace para activar tu cuenta.</p>
